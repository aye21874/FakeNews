...
**Question  7 : What are the states with maximum proportions of fake news and in what subject? Which subject has the most concentrated fake news?**
...
**Question  8 : Most dishonest States and which Subjects**
...
**Question  10 : The most controversial Subjects**
...
df %>%
  ggplot(aes(y=n, axis1=Venue, axis2=PartyAffiliation, axis3=SpeakerJobTitle)) +
  ...
  scale_x_discrete(limits = c("Venue", "Party", "Job Title"), expand = c(.1, .1)) +
