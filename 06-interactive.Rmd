...
Step 1) The user is expected to select a speaker from the list of top 10 Speaker (filtered by the number of statmenets in csv) displayed below.

Step 2) The user sees a dynamic graph for the Party Affiliation of the Speaker, and it's history in spreading Fake Vs Factual News. **Please note**, the  user is expected to click on the statement where The Party Name is Shown. 
